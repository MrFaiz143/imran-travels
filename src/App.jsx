    ...
    <div id="ticket-print" style={{
      ...
      <div style={{ width: 210, display: "flex", flexDirection: "column", background: "#fff" }}>
        ...
        <div style={{ padding: "8px 14px", flex: 1 }}>
          <div style={{ fontSize: 10, fontWeight: 650, color: "#1a237e", marginBottom: 5 }}>🚌 OUR ROUTES</div>
          {[
            ...
            <div key={i} style={{ fontSize: 10, color: "#333", padding: "2px 0", borderBottom: "1px dashed #e8eaf6", lineHeight: 1.4 }}>
              {i + 1}. {r}
            </div>
          ))}
        </div>
